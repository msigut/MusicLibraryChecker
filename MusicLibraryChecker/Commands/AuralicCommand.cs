...
{
    class AuralicCommand
    {
        public static void Execute(string path, bool fix, int minWidth = 500, int minHeight = 500, int minSizeKB = 50, bool bookletWarning = false)
        {
            ...
            foreach (var dir in info.GetDirectories())
            {
                ...
                if (folderImagesCount < 1)
                {
                    ...
                    {
                        Console.WriteLine($"{dir.FullName}: folder.jpg is missing");
                    }
                }
                ...
                if (folderImages.Any())
                {
                    ...
                    if (f.Width < minWidth || f.Height < minHeight || fi.Length < (minSizeKB * 1024))
                    {
